...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleTouchMove = (e: TouchEvent) => {
      // Only prevent default for vertical scrolling to allow horizontal scroll
    ...
    const handleTouchEnd = (e: TouchEvent) => {
      ...
      // Only trigger section change for significant vertical swipes
    ...
    <main className="relative h-screen w-full overflow-hidden bg-background" style={{ height: '100dvh' }}>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="font-mono text-xs text-foreground/60 -mt-1">Software Developer</span>
          </div>
        </button>
      ...
      >
        ...
        <section className="flex 100dvh w-screen shrink-0 flex-col justify-end px-6 pb-20 pt-24 md:px-12 md:pb-24 border-2 border-red-500" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 5rem)' }}>
          <div className="max-w-3xl border-2 border-blue-500 pb-20 md:pb-20">
            ...
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-base leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Software engineer with 1.5 year of experience crafting innovative solutions and bringing ideas to life through code.
              </span>
            </p>
